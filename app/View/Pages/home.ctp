...
?>
        ...
        <td style="text-align: center;vertical-align: bottom;"> 
            <?php
            echo $this->Html->link(
                    $this->Html->image("listar.png", array("alt" => "Listar")) . "<br>Crear Apuesta", "/games/listar", array('escape' => false)
            );
            ?>
        </td>
        <td style="text-align: center">
            <?php
            echo $this->Html->link(
                    $this->Html->image("pagar.png", array("alt" => "Pagar")) . "<br>Pagar Apuesta", "/bets/pagar", array('escape' => false)
            );
            ?>
        </td>
        <td style="text-align: center">
